...
public class level_1_1_star_move : MonoBehaviour
{ 
    public int HP = 1;//Set the planet's HP to 1
    public GameObject level2;//create the gameobject that is a prefab
    // Start is called before the first frame update
    void Start()
    {
        float a = Random.Range(150f, 250f);//a is a randomly generated force of a magnitude
